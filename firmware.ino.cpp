#include <Arduino.h>
#line 1 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
#include <WiFi.h>
...
const char* known_wifi[] = { // put your owns of course
  "aa:bb:cc:dd:ee:ff",  
  "11:22:33:44:55:66"   
};

const int KNOWN_BLE_COUNT = 2;
const char* known_ble[] = { // put your owns of course again
  "ff:ee:dd:cc:bb:aa",  
  "66:55:44:33:22:11"   
};

#line 20 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
bool isKnownWiFi(const char* mac);
#line 28 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
bool isKnownBLE(const char* mac);
#line 36 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void scanWiFi();
#line 76 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
float estimateDistance(int rssi, int txPower);
#line 84 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
String getAppleActionDescription(uint8_t actionCode);
#line 100 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
String getAdvTypeDescription(uint8_t advType);
#line 111 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
String getAddrTypeDescription(uint8_t addrType);
#line 121 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
String getPhyDescription(uint8_t phy);
#line 130 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
String getDataStatusDescription(uint8_t status);
#line 139 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void printHexDump(const std::vector<uint8_t>& payload);
#line 173 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void parseAndDecodeADStructures(const std::vector<uint8_t>& payload);
#line 230 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void scanBLE();
#line 481 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void setup();
#line 506 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
void loop();
#line 20 "C:\\Users\\User\\Downloads\\sketch_aug26a\\firmware\\firmware.ino"
bool isKnownWiFi(const char* mac) {
...
String getDataStatusDescription(uint8_t status) {
  switch (status) {
    ...
    case 1: return "Incomplete (More data expected, open a issue if this fails because i'm not entirely sure)";
...
void printHexDump(const std::vector<uint8_t>& payload) {
  Serial.println("  Raw Payload (Hex Dump):");
...
void parseAndDecodeADStructures(const std::vector<uint8_t>& payload) {
  ...
  while (idx < payload.size()) {
    ...
    if (idx + 1 + len > payload.size()) {
      Serial.println("    [-] Warning: Malformed packet structure (exceeds frame boundaries), returning just to make sure.");
      break;
    }
...
void scanBLE() { 
  ...
  for (int i = 0; i < devices; i++) {
    ...
    Serial.printf("  Est. Distance: %.2f meters (approx.)\n", estimateDistance(device->getRSSI(), txPower));
    ...
    if (device->haveManufacturerData()) {
      ...
      if (mfgData.length() >= 4) {
        ...
        if (companyId == 0x0006) {
          Serial.println("\n  [+] DECODING MICROSOFT CONNECTED DEVICES PLATFORM:");
            ...
            if (type == 0x12) {
              if (len == 2) {
                ...
                if (statusByte == 0x00 && (payloadVal <= 0x05)) {
                  ...
                  Serial.printf("        - WARNING: Spoofed / Simulated Beacon (BLE Spam/SDK Test)\n");
                ...
                Serial.println("      Parsed Tracking (0x12):");
                Serial.println("        - State: GENUINE FIND MY TRACKER");
...
void setup() {
  ...
  Serial.printf("\n[*] Entering Deep Sleep for %d seconds (5 minutes)...\n", SLEEP_TIME);
